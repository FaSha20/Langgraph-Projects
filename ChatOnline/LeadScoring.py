...
# افزونه تا حالا 20۲0 نصب فعال در ژاکت داشته،
# اگر تمایل دارین لینک دانلود افزونه و نحوه محاسبه هزینه‌ها رو براتون ارسال کنم.

# مخاطب:
# سلام وقت بخیر ما خودمون داریم کار میکنیم
...
# مخاطب:
# محصولی مشابه شما رو از یک شرکت دیگر با قیمت کمتر گرفتیم
# """
